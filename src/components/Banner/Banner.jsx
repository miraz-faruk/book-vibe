...
const Banner = () => {
    return (
        <div className="bg-[#1313130D] rounded-3xl px-14 md:px-28 py-5 md:py-10">
            <div className="flex flex-col-reverse md:flex-row gap-10 md:gap-20 items-center">
                <div>
                    <h2 className="text-2xl md:text-[56px] font-bold banner-font mb-6 md:mb-12 leading-normal">Books to freshen up your bookshelf</h2>
